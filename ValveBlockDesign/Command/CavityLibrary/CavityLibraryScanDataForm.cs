...
{
    internal partial class CavityLibraryScanEditForm : Form
    {
        ...
        public CavityLibraryScanEditForm()
        {
            InitializeComponent();
        }
        public CavityLibraryScanEditForm(string codingname, string codingnumber, string pathname, string indexname, CavityLibraryScanForm form)
        {
            InitializeComponent();
            ...
            m_cavityLibraryScanForm = form;
        }

        private void CavityLibraryScanEditForm_Load(object sender, EventArgs e)
        {
            //tb1.ReadOnly = true;
            //tb2.ReadOnly = true;
        ...
        private void CavityLibraryScanEditForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            m_cavityLibraryScanForm.Show();
        }
